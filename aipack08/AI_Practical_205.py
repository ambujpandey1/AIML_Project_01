# AI/ML Data splitting into training and testing data set for Learning
# Algorithms Evaluation (Methods:- 4 )
#-------------------------------------------

#  1) Train and Test Sets Splits.

#  2) k-fold Cross Validation Splits.

#  3) Leave One Out Cross Validation Splits.
