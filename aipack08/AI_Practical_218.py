...
#--------------------------------------------------
    ...
    #8) Spot checking for AdaBoost
    #from sklearn.ensemble import AdaBoostClassifier

    #9) Spot checking for Gradient Boosting
...
results = cross_val_score(model, X, Y, cv=kfold)
print("Validation Score for AdaBoost          : ", results.mean())
...
results = cross_val_score(model, X, Y, cv=kfold)
print("Validation Score for Gradient Boosting : ", results.mean())